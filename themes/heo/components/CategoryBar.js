  ...
  return (
    <div
      ...
      className={`wow fadeInUp flex flex-nowrap justify-between items-center h-12 mb-4 space-x-2 w-full lg:bg-white dark:lg:bg-[#1e1e1e]  
            ${border ? 'lg:border lg:hover:border dark:lg:border-gray-800 hover:border-indigo-600 dark:hover:border-white ' : ''}  py-2 lg:px-2 rounded-xl transition-colors duration-200  hover:shadow-[0_0_10px_white]`}>
      <div
